...
var middlewareSecret = "8153348b-aeb1-4424-8825-0064d6442fb3";
//#endregion
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"MODE": "production",
			"PROD": true,
			"PUBLIC_API_URL": "https://familias.vercel.app/api",
			"SITE": void 0,
			"SSR": true
		}, { _: "/Users/useit/Desktop/familias/front/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/Users/useit/Desktop/familias/front/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/descargar.ts",
			"pathname": "/api/descargar",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/guardar.ts",
			"pathname": "/api/guardar",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/seguir.ts",
			"pathname": "/api/seguir",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/auth/login.astro",
			"pathname": "/auth/login",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/auth/registro.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/autores.astro",
			"pathname": "/autores",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/biblioteca.astro",
			"pathname": "/biblioteca",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/galeria-familiar",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/galeria-familiar\\/?$",
			"segments": [[{
				"content": "galeria-familiar",
				"dynamic": false,
				"spread": false
			}]],
			"params": [],
			"component": "src/pages/galeria-familiar.astro",
			"pathname": "/galeria-familiar",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["slug"],
			"component": "src/pages/libro/[slug]/leer.astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/panel/guardados",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/panel\\/guardados\\/?$",
			"segments": [[{
				"content": "panel",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/panel/guardados.astro",
			"pathname": "/panel/guardados",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/panel/publicaciones",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/panel\\/publicaciones\\/?$",
			"segments": [[{
				"content": "panel",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/panel/publicaciones.astro",
			"pathname": "/panel/publicaciones",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/panel.astro",
			"pathname": "/panel",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/perfil.astro",
			"pathname": "/perfil",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/recursos.astro",
			"pathname": "/recursos",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/subir-libro.astro",
			"pathname": "/subir-libro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
...
var _page0 = () => import("./chunks/generic_B50XY-tM.mjs");
var _page1 = () => import("./chunks/descargar_D-uq1lFV.mjs");
var _page2 = () => import("./chunks/guardar_CEAz1-YQ.mjs");
var _page3 = () => import("./chunks/seguir_D_P4xfVY.mjs");
var _page4 = () => import("./chunks/login_Db7yw_OK.mjs");
var _page5 = () => import("./chunks/registro_C7oI0Czq.mjs");
var _page6 = () => import("./chunks/autores_loLT644l.mjs");
var _page7 = () => import("./chunks/biblioteca_BSEbCM9Q.mjs");
var _page8 = () => import("./chunks/dashboard_D4VWIc3M.mjs");
var _page9 = () => import("./chunks/galeria_Ds5CUuld.mjs");
var _page10 = () => import("./chunks/galeria-familiar_Bzp9T4Y0.mjs");
var _page11 = () => import("./chunks/leer_Bp7b7yn4.mjs");
var _page12 = () => import("./chunks/guardados_BwARIKuB.mjs");
var _page13 = () => import("./chunks/publicaciones_CbIyWQbp.mjs");
var _page14 = () => import("./chunks/panel_Cp9jEB0T.mjs");
var _page15 = () => import("./chunks/perfil_CAPtBm_t.mjs");
var _page16 = () => import("./chunks/recursos_Dgxgfwz_.mjs");
var _page17 = () => import("./chunks/subir-libro_B_50hxp4.mjs");
var _page18 = () => import("./chunks/index_Bt1hk8P5.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/api/descargar.ts", _page1],
	["src/pages/api/guardar.ts", _page2],
	["src/pages/api/seguir.ts", _page3],
	["src/pages/auth/login.astro", _page4],
	["src/pages/auth/registro.astro", _page5],
	["src/pages/autores.astro", _page6],
	["src/pages/biblioteca.astro", _page7],
	["src/pages/dashboard.astro", _page8],
	["src/pages/galeria.astro", _page9],
	["src/pages/galeria-familiar.astro", _page10],
	["src/pages/libro/[slug]/leer.astro", _page11],
	["src/pages/panel/guardados.astro", _page12],
	["src/pages/panel/publicaciones.astro", _page13],
	["src/pages/panel.astro", _page14],
	["src/pages/perfil.astro", _page15],
	["src/pages/recursos.astro", _page16],
	["src/pages/subir-libro.astro", _page17],
	["src/pages/index.astro", _page18]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///Users/useit/Desktop/familias/front/","cacheDir":"file:///Users/useit/Desktop/familias/front/node_modules/.astro/","outDir":"file:///Users/useit/Desktop/familias/front/dist/","srcDir":"file:///Users/useit/Desktop/familias/front/src/","publicDir":"file:///Users/useit/Desktop/familias/front/public/","buildClientDir":"file:///Users/useit/Desktop/familias/front/dist/client/","buildServerDir":"file:///Users/useit/Desktop/familias/front/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/descargar","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/descargar\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"descargar","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/descargar.ts","pathname":"/api/descargar","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/guardar","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/guardar\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"guardar","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/guardar.ts","pathname":"/api/guardar","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/seguir","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/seguir\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"seguir","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/seguir.ts","pathname":"/api/seguir","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/login.DDwP8eAQ.css"},{"type":"external","src":"_astro/Layout.DiqXc5M_.css"}],"routeData":{"route":"/auth/login","isIndex":false,"type":"page","pattern":"^\\/auth\\/login\\/?$","segments":[[{"content":"auth","dynamic":false,"spread":false}],[{"content":"login","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/auth/login.astro","pathname":"/auth/login","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/registro.B7E1HH9c.css"},{"type":"external","src":"_astro/Layout.DiqXc5M_.css"}],"routeData":{"route":"/auth/registro","isIndex":false,"type":"page","pattern":"^\\/auth\\/registro\\/?$","segments":[[{"content":"auth","dynamic":false,"spread":false}],[{"content":"registro","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/auth/registro.astro","pathname":"/auth/registro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/autor/[slug]","isIndex":false,"type":"page","pattern":"^\\/autor\\/([^/]+?)\\/?$","segments":[[{"content":"autor","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/autor/[slug].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Header.z0GLZhxL.css"},{"type":"external","src":"_astro/Layout.DiqXc5M_.css"},{"type":"inline","content":".cta-section[data-astro-cid-zvmdtend]{background-color:var(--color-cream);padding:3rem 0}.cta-box[data-astro-cid-zvmdtend]{background:var(--color-cream-dark);border-radius:var(--radius-lg);text-align:center;flex-direction:column;align-items:center;gap:1rem;padding:3rem 2rem;display:flex}.cta-title[data-astro-cid-zvmdtend]{font-family:var(--font-serif);color:var(--color-navy);font-size:clamp(1.4rem,3vw,1.8rem);font-weight:700}.cta-desc[data-astro-cid-zvmdtend]{color:var(--color-text-muted);max-width:480px;font-size:.95rem}.cta-btn[data-astro-cid-zvmdtend]{background:var(--color-navy);color:var(--color-white);border-radius:var(--radius-sm);align-items:center;gap:.5rem;margin-top:.25rem;padding:.8rem 1.75rem;font-size:.95rem;font-weight:600;transition:background .2s;display:inline-flex}.cta-btn[data-astro-cid-zvmdtend]:hover{background:var(--color-navy-light)}.footer[data-astro-cid-zvmdtend]{background:var(--color-white);border-top:1px solid var(--color-border);padding:3.5rem 0 0}.footer-top[data-astro-cid-zvmdtend]{grid-template-columns:2fr 1fr 1fr;gap:3rem;padding-bottom:3rem;display:grid}.footer-logo[data-astro-cid-zvmdtend]{align-items:center;gap:.5rem;margin-bottom:.75rem;display:inline-flex}.footer-logo[data-astro-cid-zvmdtend] span[data-astro-cid-zvmdtend]{font-family:var(--font-serif);color:var(--color-navy);font-size:1.2rem;font-weight:700}.footer-brand[data-astro-cid-zvmdtend]{flex-direction:column;gap:.5rem;display:flex}.footer-desc[data-astro-cid-zvmdtend]{color:var(--color-text-muted);max-width:320px;font-size:.9rem;line-height:1.55}.footer-verse[data-astro-cid-zvmdtend]{color:var(--color-text-muted);border-left:3px solid var(--color-gold);margin-top:.5rem;padding-left:.75rem;font-size:.85rem;font-style:italic;line-height:1.55}.footer-nav[data-astro-cid-zvmdtend] h3[data-astro-cid-zvmdtend]{letter-spacing:.08em;color:var(--color-text-muted);margin-bottom:1rem;font-size:.78rem;font-weight:700}.footer-nav[data-astro-cid-zvmdtend] ul[data-astro-cid-zvmdtend]{flex-direction:column;gap:.6rem;list-style:none;display:flex}.footer-nav[data-astro-cid-zvmdtend] a[data-astro-cid-zvmdtend]{color:var(--color-text);font-size:.9rem;transition:color .2s}.footer-nav[data-astro-cid-zvmdtend] a[data-astro-cid-zvmdtend]:hover{color:var(--color-navy)}.footer-bottom[data-astro-cid-zvmdtend]{border-top:1px solid var(--color-border);color:var(--color-text-muted);flex-wrap:wrap;justify-content:space-between;align-items:center;gap:.5rem;padding:1.25rem 0;font-size:.85rem;display:flex}.footer-heart[data-astro-cid-zvmdtend]{color:var(--color-text-muted)}.footer-heart[data-astro-cid-zvmdtend] span[data-astro-cid-zvmdtend]{color:#c8872a}@media (width<=768px){.footer-top[data-astro-cid-zvmdtend]{grid-template-columns:1fr;gap:2rem}}\n.page-hero[data-astro-cid-v2jexhuz]{background:linear-gradient(135deg, var(--color-primary-blue), var(--color-primary-purple), var(--color-primary-pink));color:var(--color-white);padding:3rem 0}.page-title[data-astro-cid-v2jexhuz]{font-family:var(--font-serif);margin-bottom:.5rem;font-size:clamp(2rem,4vw,2.75rem);font-weight:700}.page-desc[data-astro-cid-v2jexhuz]{color:#ffffffe6;max-width:500px;font-size:1rem}.autores-grid[data-astro-cid-v2jexhuz]{grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:1.5rem;display:grid}.autor-card[data-astro-cid-v2jexhuz]{background:var(--color-white);border-radius:var(--radius-lg);border:2px solid var(--color-primary-blue);transition:all .3s;overflow:hidden}.autor-card[data-astro-cid-v2jexhuz]:hover{box-shadow:var(--shadow-lg);border-color:var(--color-primary-pink);transform:translateY(-8px)}.autor-link[data-astro-cid-v2jexhuz]{color:inherit;text-align:center;flex-direction:column;align-items:center;padding:1.5rem;text-decoration:none;display:flex}.autor-avatar[data-astro-cid-v2jexhuz]{margin-bottom:1rem;font-size:4rem}.autor-nombre[data-astro-cid-v2jexhuz]{font-family:var(--font-serif);color:var(--color-primary-blue);margin:0 0 .5rem;font-size:1.2rem;font-weight:700}.autor-especialidad[data-astro-cid-v2jexhuz]{color:var(--color-primary-purple);margin:0 0 .5rem;font-size:.95rem;font-weight:600}.autor-bio[data-astro-cid-v2jexhuz]{color:var(--color-text-muted);margin:0 0 1rem;font-size:.85rem;line-height:1.5}.autor-stats[data-astro-cid-v2jexhuz]{flex-direction:column;gap:.75rem;width:100%;display:flex}.stat[data-astro-cid-v2jexhuz]{color:var(--color-text-muted);align-items:center;gap:.5rem;font-size:.85rem;display:flex}.stat[data-astro-cid-v2jexhuz] strong[data-astro-cid-v2jexhuz]{color:var(--color-primary-blue);font-weight:600}.centered[data-astro-cid-v2jexhuz]{text-align:center;padding:4rem 2rem}.centered[data-astro-cid-v2jexhuz] h2[data-astro-cid-v2jexhuz]{color:var(--color-primary-blue);margin-bottom:.75rem;font-size:1.75rem}@media (width<=768px){.autores-grid[data-astro-cid-v2jexhuz]{grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:1rem}}@media (width<=480px){.autores-grid[data-astro-cid-v2jexhuz]{grid-template-columns:repeat(auto-fill,minmax(140px,1fr))}.autor-nombre[data-astro-cid-v2jexhuz]{font-size:1rem}.autor-link[data-astro-cid-v2jexhuz]{padding:1rem}}\n"}],"routeData":{"route":"/autores","isIndex":false,"type":"page","pattern":"^\\/autores\\/?$","segments":[[{"content":"autores","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/autores.astro","pathname":"/autores","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Header.z0GLZhxL.css"},{"type":"external","src":"_astro/Layout.DiqXc5M_.css"},{"type":"inline","content":".cta-section[data-astro-cid-zvmdtend]{background-color:var(--color-cream);padding:3rem 0}.cta-box[data-astro-cid-zvmdtend]{background:var(--color-cream-dark);border-radius:var(--radius-lg);text-align:center;flex-direction:column;align-items:center;gap:1rem;padding:3rem 2rem;display:flex}.cta-title[data-astro-cid-zvmdtend]{font-family:var(--font-serif);color:var(--color-navy);font-size:clamp(1.4rem,3vw,1.8rem);font-weight:700}.cta-desc[data-astro-cid-zvmdtend]{color:var(--color-text-muted);max-width:480px;font-size:.95rem}.cta-btn[data-astro-cid-zvmdtend]{background:var(--color-navy);color:var(--color-white);border-radius:var(--radius-sm);align-items:center;gap:.5rem;margin-top:.25rem;padding:.8rem 1.75rem;font-size:.95rem;font-weight:600;transition:background .2s;display:inline-flex}.cta-btn[data-astro-cid-zvmdtend]:hover{background:var(--color-navy-light)}.footer[data-astro-cid-zvmdtend]{background:var(--color-white);border-top:1px solid var(--color-border);padding:3.5rem 0 0}.footer-top[data-astro-cid-zvmdtend]{grid-template-columns:2fr 1fr 1fr;gap:3rem;padding-bottom:3rem;display:grid}.footer-logo[data-astro-cid-zvmdtend]{align-items:center;gap:.5rem;margin-bottom:.75rem;display:inline-flex}.footer-logo[data-astro-cid-zvmdtend] span[data-astro-cid-zvmdtend]{font-family:var(--font-serif);color:var(--color-navy);font-size:1.2rem;font-weight:700}.footer-brand[data-astro-cid-zvmdtend]{flex-direction:column;gap:.5rem;display:flex}.footer-desc[data-astro-cid-zvmdtend]{color:var(--color-text-muted);max-width:320px;font-size:.9rem;line-height:1.55}.footer-verse[data-astro-cid-zvmdtend]{color:var(--color-text-muted);border-left:3px solid var(--color-gold);margin-top:.5rem;padding-left:.75rem;font-size:.85rem;font-style:italic;line-height:1.55}.footer-nav[data-astro-cid-zvmdtend] h3[data-astro-cid-zvmdtend]{letter-spacing:.08em;color:var(--color-text-muted);margin-bottom:1rem;font-size:.78rem;font-weight:700}.footer-nav[data-astro-cid-zvmdtend] ul[data-astro-cid-zvmdtend]{flex-direction:column;gap:.6rem;list-style:none;display:flex}.footer-nav[data-astro-cid-zvmdtend] a[data-astro-cid-zvmdtend]{color:var(--color-text);font-size:.9rem;transition:color .2s}.footer-nav[data-astro-cid-zvmdtend] a[data-astro-cid-zvmdtend]:hover{color:var(--color-navy)}.footer-bottom[data-astro-cid-zvmdtend]{border-top:1px solid var(--color-border);color:var(--color-text-muted);flex-wrap:wrap;justify-content:space-between;align-items:center;gap:.5rem;padding:1.25rem 0;font-size:.85rem;display:flex}.footer-heart[data-astro-cid-zvmdtend]{color:var(--color-text-muted)}.footer-heart[data-astro-cid-zvmdtend] span[data-astro-cid-zvmdtend]{color:#c8872a}@media (width<=768px){.footer-top[data-astro-cid-zvmdtend]{grid-template-columns:1fr;gap:2rem}}\n"},{"type":"external","src":"_astro/BookCard.C2bnUKOA.css"},{"type":"inline","content":".page-hero[data-astro-cid-xybvlisa]{background:linear-gradient(135deg, var(--color-primary-blue), var(--color-primary-purple), var(--color-primary-pink));color:var(--color-white);padding:3.5rem 0;position:relative;overflow:hidden}.page-hero[data-astro-cid-xybvlisa]:before{content:\"\";pointer-events:none;background-image:radial-gradient(circle at 20%,#ffd73d26 0%,#0000 50%),radial-gradient(circle at 80%,#ffd73d26 0%,#0000 50%);position:absolute;inset:0}.hero-content[data-astro-cid-xybvlisa]{z-index:1;position:relative}.page-title[data-astro-cid-xybvlisa]{font-family:var(--font-serif);margin-bottom:.75rem;font-size:clamp(2rem,4vw,3rem);font-weight:700;animation:.6s ease-out slideInDown}@keyframes slideInDown{0%{opacity:0;transform:translateY(-20px)}to{opacity:1;transform:translateY(0)}}.page-desc[data-astro-cid-xybvlisa]{color:#fffffff2;max-width:600px;font-size:1.05rem;animation:.6s ease-out .15s backwards slideInDown}.biblioteca-layout[data-astro-cid-xybvlisa]{grid-template-columns:220px 1fr;align-items:start;gap:2.5rem;display:grid}.sidebar[data-astro-cid-xybvlisa]{flex-direction:column;gap:1.75rem;display:flex;position:sticky;top:80px}.sidebar-title[data-astro-cid-xybvlisa]{letter-spacing:.05em;color:var(--color-primary-blue);text-transform:uppercase;margin-bottom:.75rem;font-size:.9rem;font-weight:700}.filter-list[data-astro-cid-xybvlisa]{flex-direction:column;gap:.3rem;list-style:none;display:flex}.filter-link[data-astro-cid-xybvlisa]{border-radius:var(--radius-md);color:var(--color-text);background:0 0;border-left:4px solid #0000;padding:.55rem .85rem;font-size:.9rem;font-weight:500;transition:all .2s;display:block}.filter-link[data-astro-cid-xybvlisa]:hover{background:var(--color-primary-blue);color:var(--color-white);transform:translate(4px)}.filter-link[data-astro-cid-xybvlisa].active{background:linear-gradient(90deg, var(--color-primary-blue), var(--color-primary-purple));color:var(--color-white);border-left:4px solid var(--color-primary-pink);font-weight:600}.results-header[data-astro-cid-xybvlisa]{margin-bottom:1.5rem}.results-count[data-astro-cid-xybvlisa]{color:var(--color-text-muted);font-size:.9rem}.results-count[data-astro-cid-xybvlisa] strong[data-astro-cid-xybvlisa]{color:var(--color-navy)}.books-grid[data-astro-cid-xybvlisa]{grid-template-columns:repeat(3,1fr);gap:1.5rem;display:grid}@media (width<=1200px){.books-grid[data-astro-cid-xybvlisa]{grid-template-columns:repeat(2,1fr);gap:1.5rem}}@media (width<=900px){.biblioteca-layout[data-astro-cid-xybvlisa]{grid-template-columns:1fr;gap:2rem}.sidebar[data-astro-cid-xybvlisa]{grid-template-columns:repeat(2,1fr);gap:1rem;display:grid;position:static}.sidebar-section[data-astro-cid-xybvlisa]{background:var(--color-white);border-radius:var(--radius-md);border:2px solid var(--color-primary-blue);padding:1.25rem}.books-grid[data-astro-cid-xybvlisa]{grid-template-columns:repeat(2,1fr);gap:1.25rem}}@media (width<=680px){.sidebar[data-astro-cid-xybvlisa]{grid-template-columns:1fr}.books-grid[data-astro-cid-xybvlisa]{grid-template-columns:1fr;gap:1rem}.page-title[data-astro-cid-xybvlisa]{font-size:clamp(1.5rem,3vw,2rem)}.page-desc[data-astro-cid-xybvlisa]{font-size:.95rem}}@media (width<=480px){.section[data-astro-cid-xybvlisa],.page-hero[data-astro-cid-xybvlisa]{padding:2rem 0}.sidebar-section[data-astro-cid-xybvlisa]{border-radius:var(--radius-md);padding:1rem}.sidebar-title[data-astro-cid-xybvlisa]{margin-bottom:.5rem;font-size:.8rem}.filter-link[data-astro-cid-xybvlisa]{padding:.5rem .65rem;font-size:.85rem}.books-grid[data-astro-cid-xybvlisa]{gap:.75rem}}.empty-state[data-astro-cid-xybvlisa]{text-align:center;color:var(--color-text-muted);flex-direction:column;align-items:center;gap:1rem;padding:4rem 2rem;display:flex}.btn-reset[data-astro-cid-xybvlisa]{background:var(--color-navy);color:var(--color-white);border-radius:var(--radius-sm);padding:.55rem 1.25rem;font-size:.9rem;font-weight:600;transition:background .2s;display:inline-flex}.btn-reset[data-astro-cid-xybvlisa]:hover{background:var(--color-navy-light)}\n"}],"routeData":{"route":"/biblioteca","isIndex":false,"type":"page","pattern":"^\\/biblioteca\\/?$","segments":[[{"content":"biblioteca","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/biblioteca.astro","pathname":"/biblioteca","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/dashboard.Bd5XCDbe.css"},{"type":"external","src":"_astro/Layout.DiqXc5M_.css"}],"routeData":{"route":"/dashboard","isIndex":false,"type":"page","pattern":"^\\/dashboard\\/?$","segments":[[{"content":"dashboard","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/dashboard.astro","pathname":"/dashboard","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Header.z0GLZhxL.css"},{"type":"external","src":"_astro/Layout.DiqXc5M_.css"},{"type":"inline","content":".cta-section[data-astro-cid-zvmdtend]{background-color:var(--color-cream);padding:3rem 0}.cta-box[data-astro-cid-zvmdtend]{background:var(--color-cream-dark);border-radius:var(--radius-lg);text-align:center;flex-direction:column;align-items:center;gap:1rem;padding:3rem 2rem;display:flex}.cta-title[data-astro-cid-zvmdtend]{font-family:var(--font-serif);color:var(--color-navy);font-size:clamp(1.4rem,3vw,1.8rem);font-weight:700}.cta-desc[data-astro-cid-zvmdtend]{color:var(--color-text-muted);max-width:480px;font-size:.95rem}.cta-btn[data-astro-cid-zvmdtend]{background:var(--color-navy);color:var(--color-white);border-radius:var(--radius-sm);align-items:center;gap:.5rem;margin-top:.25rem;padding:.8rem 1.75rem;font-size:.95rem;font-weight:600;transition:background .2s;display:inline-flex}.cta-btn[data-astro-cid-zvmdtend]:hover{background:var(--color-navy-light)}.footer[data-astro-cid-zvmdtend]{background:var(--color-white);border-top:1px solid var(--color-border);padding:3.5rem 0 0}.footer-top[data-astro-cid-zvmdtend]{grid-template-columns:2fr 1fr 1fr;gap:3rem;padding-bottom:3rem;display:grid}.footer-logo[data-astro-cid-zvmdtend]{align-items:center;gap:.5rem;margin-bottom:.75rem;display:inline-flex}.footer-logo[data-astro-cid-zvmdtend] span[data-astro-cid-zvmdtend]{font-family:var(--font-serif);color:var(--color-navy);font-size:1.2rem;font-weight:700}.footer-brand[data-astro-cid-zvmdtend]{flex-direction:column;gap:.5rem;display:flex}.footer-desc[data-astro-cid-zvmdtend]{color:var(--color-text-muted);max-width:320px;font-size:.9rem;line-height:1.55}.footer-verse[data-astro-cid-zvmdtend]{color:var(--color-text-muted);border-left:3px solid var(--color-gold);margin-top:.5rem;padding-left:.75rem;font-size:.85rem;font-style:italic;line-height:1.55}.footer-nav[data-astro-cid-zvmdtend] h3[data-astro-cid-zvmdtend]{letter-spacing:.08em;color:var(--color-text-muted);margin-bottom:1rem;font-size:.78rem;font-weight:700}.footer-nav[data-astro-cid-zvmdtend] ul[data-astro-cid-zvmdtend]{flex-direction:column;gap:.6rem;list-style:none;display:flex}.footer-nav[data-astro-cid-zvmdtend] a[data-astro-cid-zvmdtend]{color:var(--color-text);font-size:.9rem;transition:color .2s}.footer-nav[data-astro-cid-zvmdtend] a[data-astro-cid-zvmdtend]:hover{color:var(--color-navy)}.footer-bottom[data-astro-cid-zvmdtend]{border-top:1px solid var(--color-border);color:var(--color-text-muted);flex-wrap:wrap;justify-content:space-between;align-items:center;gap:.5rem;padding:1.25rem 0;font-size:.85rem;display:flex}.footer-heart[data-astro-cid-zvmdtend]{color:var(--color-text-muted)}.footer-heart[data-astro-cid-zvmdtend] span[data-astro-cid-zvmdtend]{color:#c8872a}@media (width<=768px){.footer-top[data-astro-cid-zvmdtend]{grid-template-columns:1fr;gap:2rem}}\n.page-hero[data-astro-cid-7pd5emi5]{background:var(--color-navy);color:var(--color-white);padding:3.5rem 0}.page-title[data-astro-cid-7pd5emi5]{font-family:var(--font-serif);margin-bottom:.5rem;font-size:clamp(2rem,4vw,2.75rem);font-weight:700}.page-desc[data-astro-cid-7pd5emi5]{color:#ffffffb3;max-width:500px;font-size:1rem}.cat-filter[data-astro-cid-7pd5emi5]{flex-wrap:wrap;gap:.5rem;margin-bottom:2rem;display:flex}.cat-btn[data-astro-cid-7pd5emi5]{border:1.5px solid var(--color-border);color:var(--color-text-muted);border-radius:100px;padding:.4rem 1rem;font-size:.88rem;font-weight:500;transition:all .2s}.cat-btn[data-astro-cid-7pd5emi5]:hover{border-color:var(--color-navy);color:var(--color-navy)}.cat-btn[data-astro-cid-7pd5emi5].active{background:var(--color-navy);border-color:var(--color-navy);color:var(--color-white)}.videos-grid[data-astro-cid-7pd5emi5]{grid-template-columns:repeat(3,1fr);gap:1.5rem;display:grid}.video-card[data-astro-cid-7pd5emi5]{background:var(--color-white);border-radius:var(--radius-lg);box-shadow:var(--shadow-sm);border:1px solid var(--color-border);transition:box-shadow .25s,transform .25s;overflow:hidden}.video-card[data-astro-cid-7pd5emi5]:hover{box-shadow:var(--shadow-md);transform:translateY(-3px)}.video-card[data-astro-cid-7pd5emi5]:hover .video-play[data-astro-cid-7pd5emi5]{opacity:1}.video-card-link[data-astro-cid-7pd5emi5]{flex-direction:column;display:flex}.video-thumb[data-astro-cid-7pd5emi5]{aspect-ratio:16/9;justify-content:center;align-items:center;display:flex;position:relative}.video-emoji[data-astro-cid-7pd5emi5]{opacity:.45;pointer-events:none;font-size:2.5rem}.video-duration[data-astro-cid-7pd5emi5]{color:#fff;background:#000000bf;border-radius:4px;padding:.2rem .5rem;font-size:.78rem;font-weight:600;position:absolute;bottom:.6rem;right:.6rem}.video-play[data-astro-cid-7pd5emi5]{width:48px;height:48px;color:var(--color-navy);opacity:0;background:#ffffffe6;border-radius:50%;justify-content:center;align-items:center;transition:opacity .2s;display:flex}.video-info[data-astro-cid-7pd5emi5]{flex-direction:column;gap:.45rem;padding:1rem;display:flex}.video-cat-badge[data-astro-cid-7pd5emi5]{color:var(--color-gold);text-transform:uppercase;letter-spacing:.05em;font-size:.75rem;font-weight:600}.video-titulo[data-astro-cid-7pd5emi5]{font-family:var(--font-serif);color:var(--color-navy);font-size:1rem;font-weight:700;line-height:1.3}.video-meta[data-astro-cid-7pd5emi5]{color:var(--color-text-muted);justify-content:space-between;align-items:center;font-size:.85rem;display:flex}.video-vistas[data-astro-cid-7pd5emi5]{align-items:center;gap:.3rem;display:flex}@media (width<=900px){.videos-grid[data-astro-cid-7pd5emi5]{grid-template-columns:repeat(2,1fr)}}@media (width<=480px){.videos-grid[data-astro-cid-7pd5emi5]{grid-template-columns:1fr}}\n"}],"routeData":{"route":"/galeria","isIndex":false,"type":"page","pattern":"^\\/galeria\\/?$","segments":[[{"content":"galeria","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/galeria.astro","pathname":"/galeria","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Header.z0GLZhxL.css"},{"type":"external","src":"_astro/Layout.DiqXc5M_.css"},{"type":"inline","content":".cta-section[data-astro-cid-zvmdtend]{background-color:var(--color-cream);padding:3rem 0}.cta-box[data-astro-cid-zvmdtend]{background:var(--color-cream-dark);border-radius:var(--radius-lg);text-align:center;flex-direction:column;align-items:center;gap:1rem;padding:3rem 2rem;display:flex}.cta-title[data-astro-cid-zvmdtend]{font-family:var(--font-serif);color:var(--color-navy);font-size:clamp(1.4rem,3vw,1.8rem);font-weight:700}.cta-desc[data-astro-cid-zvmdtend]{color:var(--color-text-muted);max-width:480px;font-size:.95rem}.cta-btn[data-astro-cid-zvmdtend]{background:var(--color-navy);color:var(--color-white);border-radius:var(--radius-sm);align-items:center;gap:.5rem;margin-top:.25rem;padding:.8rem 1.75rem;font-size:.95rem;font-weight:600;transition:background .2s;display:inline-flex}.cta-btn[data-astro-cid-zvmdtend]:hover{background:var(--color-navy-light)}.footer[data-astro-cid-zvmdtend]{background:var(--color-white);border-top:1px solid var(--color-border);padding:3.5rem 0 0}.footer-top[data-astro-cid-zvmdtend]{grid-template-columns:2fr 1fr 1fr;gap:3rem;padding-bottom:3rem;display:grid}.footer-logo[data-astro-cid-zvmdtend]{align-items:center;gap:.5rem;margin-bottom:.75rem;display:inline-flex}.footer-logo[data-astro-cid-zvmdtend] span[data-astro-cid-zvmdtend]{font-family:var(--font-serif);color:var(--color-navy);font-size:1.2rem;font-weight:700}.footer-brand[data-astro-cid-zvmdtend]{flex-direction:column;gap:.5rem;display:flex}.footer-desc[data-astro-cid-zvmdtend]{color:var(--color-text-muted);max-width:320px;font-size:.9rem;line-height:1.55}.footer-verse[data-astro-cid-zvmdtend]{color:var(--color-text-muted);border-left:3px solid var(--color-gold);margin-top:.5rem;padding-left:.75rem;font-size:.85rem;font-style:italic;line-height:1.55}.footer-nav[data-astro-cid-zvmdtend] h3[data-astro-cid-zvmdtend]{letter-spacing:.08em;color:var(--color-text-muted);margin-bottom:1rem;font-size:.78rem;font-weight:700}.footer-nav[data-astro-cid-zvmdtend] ul[data-astro-cid-zvmdtend]{flex-direction:column;gap:.6rem;list-style:none;display:flex}.footer-nav[data-astro-cid-zvmdtend] a[data-astro-cid-zvmdtend]{color:var(--color-text);font-size:.9rem;transition:color .2s}.footer-nav[data-astro-cid-zvmdtend] a[data-astro-cid-zvmdtend]:hover{color:var(--color-navy)}.footer-bottom[data-astro-cid-zvmdtend]{border-top:1px solid var(--color-border);color:var(--color-text-muted);flex-wrap:wrap;justify-content:space-between;align-items:center;gap:.5rem;padding:1.25rem 0;font-size:.85rem;display:flex}.footer-heart[data-astro-cid-zvmdtend]{color:var(--color-text-muted)}.footer-heart[data-astro-cid-zvmdtend] span[data-astro-cid-zvmdtend]{color:#c8872a}@media (width<=768px){.footer-top[data-astro-cid-zvmdtend]{grid-template-columns:1fr;gap:2rem}}\n.page-hero[data-astro-cid-urfchaki]{background:var(--color-navy);color:var(--color-white);padding:3.5rem 0}.page-title[data-astro-cid-urfchaki]{font-family:var(--font-serif);margin-bottom:.5rem;font-size:clamp(2rem,4vw,2.75rem);font-weight:700}.page-desc[data-astro-cid-urfchaki]{color:#ffffffb3;max-width:500px;font-size:1rem}.galeria-grid[data-astro-cid-urfchaki]{grid-template-columns:repeat(3,1fr);gap:1.5rem;display:grid}.familia-card[data-astro-cid-urfchaki]{background:var(--color-white);border-radius:var(--radius-lg);border:1px solid var(--color-border);box-shadow:var(--shadow-sm);flex-direction:column;gap:.85rem;padding:1.5rem;display:flex}.familia-header[data-astro-cid-urfchaki]{align-items:center;gap:.75rem;display:flex}.familia-avatar[data-astro-cid-urfchaki]{background:var(--color-cream);border:1px solid var(--color-border);border-radius:50%;justify-content:center;align-items:center;width:40px;min-width:40px;height:40px;display:flex}.familia-nombre[data-astro-cid-urfchaki]{color:var(--color-navy);font-size:.95rem;font-weight:600}.familia-fecha[data-astro-cid-urfchaki]{color:var(--color-text-muted);font-size:.8rem;display:block}.familia-img[data-astro-cid-urfchaki]{aspect-ratio:4/3;background:var(--color-cream-dark);border-radius:var(--radius-sm);width:100%}.familia-texto[data-astro-cid-urfchaki]{color:var(--color-text);flex:1;font-size:.9rem;line-height:1.6}.familia-divider[data-astro-cid-urfchaki]{border:none;border-top:1px solid var(--color-border);margin:0}.familia-footer[data-astro-cid-urfchaki]{justify-content:space-between;align-items:center;display:flex}.familia-like[data-astro-cid-urfchaki]{color:var(--color-text-muted);cursor:pointer;font-size:.88rem;font-family:var(--font-sans);background:0 0;border:none;align-items:center;gap:.4rem;transition:color .2s;display:flex}.familia-like[data-astro-cid-urfchaki]:hover{color:#e05c5c}.familia-tipo[data-astro-cid-urfchaki]{border:1px solid var(--color-border);color:var(--color-text-muted);border-radius:100px;padding:.2rem .7rem;font-size:.8rem}.cta-participar[data-astro-cid-urfchaki]{background:var(--color-cream);padding:3rem 0}.cta-box[data-astro-cid-urfchaki]{background:var(--color-cream-dark);border-radius:var(--radius-lg);text-align:center;padding:3rem 2rem}.cta-box[data-astro-cid-urfchaki] h2[data-astro-cid-urfchaki]{font-family:var(--font-serif);color:var(--color-navy);margin-bottom:.5rem;font-size:1.6rem;font-weight:700}.cta-box[data-astro-cid-urfchaki] p[data-astro-cid-urfchaki]{color:var(--color-text-muted);margin-bottom:1.25rem}.cta-btn[data-astro-cid-urfchaki]{background:var(--color-navy);color:var(--color-white);border-radius:var(--radius-sm);padding:.75rem 1.75rem;font-size:.95rem;font-weight:600;transition:background .2s;display:inline-flex}.cta-btn[data-astro-cid-urfchaki]:hover{background:var(--color-navy-light)}@media (width<=900px){.galeria-grid[data-astro-cid-urfchaki]{grid-template-columns:repeat(2,1fr)}}@media (width<=480px){.galeria-grid[data-astro-cid-urfchaki]{grid-template-columns:1fr}}\n"}],"routeData":{"route":"/galeria-familiar","isIndex":false,"type":"page","pattern":"^\\/galeria-familiar\\/?$","segments":[[{"content":"galeria-familiar","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/galeria-familiar.astro","pathname":"/galeria-familiar","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/leer/[slug]","isIndex":false,"type":"page","pattern":"^\\/leer\\/([^/]+?)\\/?$","segments":[[{"content":"leer","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/leer/[slug].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/leer.Bi4w_N9S.css"},{"type":"external","src":"_astro/Layout.DiqXc5M_.css"}],"routeData":{"route":"/libro/[slug]/leer","isIndex":false,"type":"page","pattern":"^\\/libro\\/([^/]+?)\\/leer\\/?$","segments":[[{"content":"libro","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}],[{"content":"leer","dynamic":false,"spread":false}]],"params":["slug"],"component":"src/pages/libro/[slug]/leer.astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/libro/[slug]","isIndex":false,"type":"page","pattern":"^\\/libro\\/([^/]+?)\\/?$","segments":[[{"content":"libro","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/libro/[slug].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Header.z0GLZhxL.css"},{"type":"external","src":"_astro/Layout.DiqXc5M_.css"},{"type":"inline","content":".cta-section[data-astro-cid-zvmdtend]{background-color:var(--color-cream);padding:3rem 0}.cta-box[data-astro-cid-zvmdtend]{background:var(--color-cream-dark);border-radius:var(--radius-lg);text-align:center;flex-direction:column;align-items:center;gap:1rem;padding:3rem 2rem;display:flex}.cta-title[data-astro-cid-zvmdtend]{font-family:var(--font-serif);color:var(--color-navy);font-size:clamp(1.4rem,3vw,1.8rem);font-weight:700}.cta-desc[data-astro-cid-zvmdtend]{color:var(--color-text-muted);max-width:480px;font-size:.95rem}.cta-btn[data-astro-cid-zvmdtend]{background:var(--color-navy);color:var(--color-white);border-radius:var(--radius-sm);align-items:center;gap:.5rem;margin-top:.25rem;padding:.8rem 1.75rem;font-size:.95rem;font-weight:600;transition:background .2s;display:inline-flex}.cta-btn[data-astro-cid-zvmdtend]:hover{background:var(--color-navy-light)}.footer[data-astro-cid-zvmdtend]{background:var(--color-white);border-top:1px solid var(--color-border);padding:3.5rem 0 0}.footer-top[data-astro-cid-zvmdtend]{grid-template-columns:2fr 1fr 1fr;gap:3rem;padding-bottom:3rem;display:grid}.footer-logo[data-astro-cid-zvmdtend]{align-items:center;gap:.5rem;margin-bottom:.75rem;display:inline-flex}.footer-logo[data-astro-cid-zvmdtend] span[data-astro-cid-zvmdtend]{font-family:var(--font-serif);color:var(--color-navy);font-size:1.2rem;font-weight:700}.footer-brand[data-astro-cid-zvmdtend]{flex-direction:column;gap:.5rem;display:flex}.footer-desc[data-astro-cid-zvmdtend]{color:var(--color-text-muted);max-width:320px;font-size:.9rem;line-height:1.55}.footer-verse[data-astro-cid-zvmdtend]{color:var(--color-text-muted);border-left:3px solid var(--color-gold);margin-top:.5rem;padding-left:.75rem;font-size:.85rem;font-style:italic;line-height:1.55}.footer-nav[data-astro-cid-zvmdtend] h3[data-astro-cid-zvmdtend]{letter-spacing:.08em;color:var(--color-text-muted);margin-bottom:1rem;font-size:.78rem;font-weight:700}.footer-nav[data-astro-cid-zvmdtend] ul[data-astro-cid-zvmdtend]{flex-direction:column;gap:.6rem;list-style:none;display:flex}.footer-nav[data-astro-cid-zvmdtend] a[data-astro-cid-zvmdtend]{color:var(--color-text);font-size:.9rem;transition:color .2s}.footer-nav[data-astro-cid-zvmdtend] a[data-astro-cid-zvmdtend]:hover{color:var(--color-navy)}.footer-bottom[data-astro-cid-zvmdtend]{border-top:1px solid var(--color-border);color:var(--color-text-muted);flex-wrap:wrap;justify-content:space-between;align-items:center;gap:.5rem;padding:1.25rem 0;font-size:.85rem;display:flex}.footer-heart[data-astro-cid-zvmdtend]{color:var(--color-text-muted)}.footer-heart[data-astro-cid-zvmdtend] span[data-astro-cid-zvmdtend]{color:#c8872a}@media (width<=768px){.footer-top[data-astro-cid-zvmdtend]{grid-template-columns:1fr;gap:2rem}}\n"},{"type":"external","src":"_astro/guardados.CzT4VZhn.css"}],"routeData":{"route":"/panel/guardados","isIndex":false,"type":"page","pattern":"^\\/panel\\/guardados\\/?$","segments":[[{"content":"panel","dynamic":false,"spread":false}],[{"content":"guardados","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/panel/guardados.astro","pathname":"/panel/guardados","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Header.z0GLZhxL.css"},{"type":"external","src":"_astro/Layout.DiqXc5M_.css"},{"type":"inline","content":".cta-section[data-astro-cid-zvmdtend]{background-color:var(--color-cream);padding:3rem 0}.cta-box[data-astro-cid-zvmdtend]{background:var(--color-cream-dark);border-radius:var(--radius-lg);text-align:center;flex-direction:column;align-items:center;gap:1rem;padding:3rem 2rem;display:flex}.cta-title[data-astro-cid-zvmdtend]{font-family:var(--font-serif);color:var(--color-navy);font-size:clamp(1.4rem,3vw,1.8rem);font-weight:700}.cta-desc[data-astro-cid-zvmdtend]{color:var(--color-text-muted);max-width:480px;font-size:.95rem}.cta-btn[data-astro-cid-zvmdtend]{background:var(--color-navy);color:var(--color-white);border-radius:var(--radius-sm);align-items:center;gap:.5rem;margin-top:.25rem;padding:.8rem 1.75rem;font-size:.95rem;font-weight:600;transition:background .2s;display:inline-flex}.cta-btn[data-astro-cid-zvmdtend]:hover{background:var(--color-navy-light)}.footer[data-astro-cid-zvmdtend]{background:var(--color-white);border-top:1px solid var(--color-border);padding:3.5rem 0 0}.footer-top[data-astro-cid-zvmdtend]{grid-template-columns:2fr 1fr 1fr;gap:3rem;padding-bottom:3rem;display:grid}.footer-logo[data-astro-cid-zvmdtend]{align-items:center;gap:.5rem;margin-bottom:.75rem;display:inline-flex}.footer-logo[data-astro-cid-zvmdtend] span[data-astro-cid-zvmdtend]{font-family:var(--font-serif);color:var(--color-navy);font-size:1.2rem;font-weight:700}.footer-brand[data-astro-cid-zvmdtend]{flex-direction:column;gap:.5rem;display:flex}.footer-desc[data-astro-cid-zvmdtend]{color:var(--color-text-muted);max-width:320px;font-size:.9rem;line-height:1.55}.footer-verse[data-astro-cid-zvmdtend]{color:var(--color-text-muted);border-left:3px solid var(--color-gold);margin-top:.5rem;padding-left:.75rem;font-size:.85rem;font-style:italic;line-height:1.55}.footer-nav[data-astro-cid-zvmdtend] h3[data-astro-cid-zvmdtend]{letter-spacing:.08em;color:var(--color-text-muted);margin-bottom:1rem;font-size:.78rem;font-weight:700}.footer-nav[data-astro-cid-zvmdtend] ul[data-astro-cid-zvmdtend]{flex-direction:column;gap:.6rem;list-style:none;display:flex}.footer-nav[data-astro-cid-zvmdtend] a[data-astro-cid-zvmdtend]{color:var(--color-text);font-size:.9rem;transition:color .2s}.footer-nav[data-astro-cid-zvmdtend] a[data-astro-cid-zvmdtend]:hover{color:var(--color-navy)}.footer-bottom[data-astro-cid-zvmdtend]{border-top:1px solid var(--color-border);color:var(--color-text-muted);flex-wrap:wrap;justify-content:space-between;align-items:center;gap:.5rem;padding:1.25rem 0;font-size:.85rem;display:flex}.footer-heart[data-astro-cid-zvmdtend]{color:var(--color-text-muted)}.footer-heart[data-astro-cid-zvmdtend] span[data-astro-cid-zvmdtend]{color:#c8872a}@media (width<=768px){.footer-top[data-astro-cid-zvmdtend]{grid-template-columns:1fr;gap:2rem}}\n"},{"type":"external","src":"_astro/publicaciones.CDPmhXta.css"}],"routeData":{"route":"/panel/publicaciones","isIndex":false,"type":"page","pattern":"^\\/panel\\/publicaciones\\/?$","segments":[[{"content":"panel","dynamic":false,"spread":false}],[{"content":"publicaciones","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/panel/publicaciones.astro","pathname":"/panel/publicaciones","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Header.z0GLZhxL.css"},{"type":"external","src":"_astro/Layout.DiqXc5M_.css"},{"type":"inline","content":".cta-section[data-astro-cid-zvmdtend]{background-color:var(--color-cream);padding:3rem 0}.cta-box[data-astro-cid-zvmdtend]{background:var(--color-cream-dark);border-radius:var(--radius-lg);text-align:center;flex-direction:column;align-items:center;gap:1rem;padding:3rem 2rem;display:flex}.cta-title[data-astro-cid-zvmdtend]{font-family:var(--font-serif);color:var(--color-navy);font-size:clamp(1.4rem,3vw,1.8rem);font-weight:700}.cta-desc[data-astro-cid-zvmdtend]{color:var(--color-text-muted);max-width:480px;font-size:.95rem}.cta-btn[data-astro-cid-zvmdtend]{background:var(--color-navy);color:var(--color-white);border-radius:var(--radius-sm);align-items:center;gap:.5rem;margin-top:.25rem;padding:.8rem 1.75rem;font-size:.95rem;font-weight:600;transition:background .2s;display:inline-flex}.cta-btn[data-astro-cid-zvmdtend]:hover{background:var(--color-navy-light)}.footer[data-astro-cid-zvmdtend]{background:var(--color-white);border-top:1px solid var(--color-border);padding:3.5rem 0 0}.footer-top[data-astro-cid-zvmdtend]{grid-template-columns:2fr 1fr 1fr;gap:3rem;padding-bottom:3rem;display:grid}.footer-logo[data-astro-cid-zvmdtend]{align-items:center;gap:.5rem;margin-bottom:.75rem;display:inline-flex}.footer-logo[data-astro-cid-zvmdtend] span[data-astro-cid-zvmdtend]{font-family:var(--font-serif);color:var(--color-navy);font-size:1.2rem;font-weight:700}.footer-brand[data-astro-cid-zvmdtend]{flex-direction:column;gap:.5rem;display:flex}.footer-desc[data-astro-cid-zvmdtend]{color:var(--color-text-muted);max-width:320px;font-size:.9rem;line-height:1.55}.footer-verse[data-astro-cid-zvmdtend]{color:var(--color-text-muted);border-left:3px solid var(--color-gold);margin-top:.5rem;padding-left:.75rem;font-size:.85rem;font-style:italic;line-height:1.55}.footer-nav[data-astro-cid-zvmdtend] h3[data-astro-cid-zvmdtend]{letter-spacing:.08em;color:var(--color-text-muted);margin-bottom:1rem;font-size:.78rem;font-weight:700}.footer-nav[data-astro-cid-zvmdtend] ul[data-astro-cid-zvmdtend]{flex-direction:column;gap:.6rem;list-style:none;display:flex}.footer-nav[data-astro-cid-zvmdtend] a[data-astro-cid-zvmdtend]{color:var(--color-text);font-size:.9rem;transition:color .2s}.footer-nav[data-astro-cid-zvmdtend] a[data-astro-cid-zvmdtend]:hover{color:var(--color-navy)}.footer-bottom[data-astro-cid-zvmdtend]{border-top:1px solid var(--color-border);color:var(--color-text-muted);flex-wrap:wrap;justify-content:space-between;align-items:center;gap:.5rem;padding:1.25rem 0;font-size:.85rem;display:flex}.footer-heart[data-astro-cid-zvmdtend]{color:var(--color-text-muted)}.footer-heart[data-astro-cid-zvmdtend] span[data-astro-cid-zvmdtend]{color:#c8872a}@media (width<=768px){.footer-top[data-astro-cid-zvmdtend]{grid-template-columns:1fr;gap:2rem}}\n"},{"type":"external","src":"_astro/BookCard.C2bnUKOA.css"},{"type":"inline","content":".panel-hero[data-astro-cid-6bxwsqyu]{background:var(--color-cream);border-bottom:1px solid var(--color-border);padding:2rem 0}.panel-hero-inner[data-astro-cid-6bxwsqyu]{flex-wrap:wrap;align-items:center;gap:1.25rem;display:flex}.panel-avatar[data-astro-cid-6bxwsqyu]{background:var(--color-white);border:2px solid var(--color-border);border-radius:50%;justify-content:center;align-items:center;width:64px;min-width:64px;height:64px;display:flex}.panel-nombre[data-astro-cid-6bxwsqyu]{font-family:var(--font-serif);color:var(--color-navy);font-size:1.5rem;font-weight:700}.panel-email[data-astro-cid-6bxwsqyu]{color:var(--color-text-muted);font-size:.88rem}.btn-edit[data-astro-cid-6bxwsqyu]{border:1.5px solid var(--color-border);border-radius:var(--radius-sm);color:var(--color-navy);align-items:center;gap:.4rem;margin-left:auto;padding:.5rem 1rem;font-size:.88rem;font-weight:500;transition:border-color .2s,background .2s;display:inline-flex}.btn-edit[data-astro-cid-6bxwsqyu]:hover{border-color:var(--color-navy);background:var(--color-white)}.btn-upload[data-astro-cid-6bxwsqyu]{border-radius:var(--radius-sm);color:#b8860b;background:#fffbf0;border:1.5px solid #d4af37;align-items:center;gap:.4rem;padding:.5rem 1rem;font-size:.88rem;font-weight:500;transition:all .2s;display:inline-flex}.btn-upload[data-astro-cid-6bxwsqyu]:hover{background:#fff8e7;border-color:#b8860b}.panel-layout[data-astro-cid-6bxwsqyu]{grid-template-columns:200px 1fr;align-items:start;gap:2.5rem;display:grid}.panel-nav[data-astro-cid-6bxwsqyu]{position:sticky;top:80px}.panel-nav-list[data-astro-cid-6bxwsqyu]{flex-direction:column;gap:.2rem;list-style:none;display:flex}.panel-nav-link[data-astro-cid-6bxwsqyu]{border-radius:var(--radius-sm);color:var(--color-text-muted);align-items:center;gap:.6rem;padding:.55rem .75rem;font-size:.9rem;transition:all .15s;display:flex}.panel-nav-link[data-astro-cid-6bxwsqyu]:hover{background:var(--color-cream);color:var(--color-navy)}.panel-nav-link[data-astro-cid-6bxwsqyu].active{background:var(--color-cream-dark);color:var(--color-navy);font-weight:600}.panel-content[data-astro-cid-6bxwsqyu]{flex-direction:column;gap:2.5rem;display:flex}.stats-row[data-astro-cid-6bxwsqyu]{grid-template-columns:repeat(3,1fr);gap:1rem;display:grid}.stat-card[data-astro-cid-6bxwsqyu]{background:var(--color-white);border:1px solid var(--color-border);border-radius:var(--radius-md);text-align:center;box-shadow:var(--shadow-sm);flex-direction:column;align-items:center;gap:.2rem;padding:1.25rem;display:flex}.stat-card[data-astro-cid-6bxwsqyu] strong[data-astro-cid-6bxwsqyu]{color:var(--color-navy);font-size:1.75rem;font-weight:700}.stat-card[data-astro-cid-6bxwsqyu] span[data-astro-cid-6bxwsqyu]{color:var(--color-text-muted);font-size:.82rem}.panel-section[data-astro-cid-6bxwsqyu]{flex-direction:column;gap:1.25rem;display:flex}.panel-books-grid[data-astro-cid-6bxwsqyu]{grid-template-columns:repeat(3,1fr);gap:1.25rem;display:grid}@media (width<=900px){.panel-layout[data-astro-cid-6bxwsqyu]{grid-template-columns:1fr}.panel-nav[data-astro-cid-6bxwsqyu]{position:static}.panel-nav-list[data-astro-cid-6bxwsqyu]{flex-flow:wrap}.panel-books-grid[data-astro-cid-6bxwsqyu]{grid-template-columns:repeat(2,1fr)}.btn-edit[data-astro-cid-6bxwsqyu]{margin-left:0}}@media (width<=480px){.panel-books-grid[data-astro-cid-6bxwsqyu]{grid-template-columns:1fr}.stats-row[data-astro-cid-6bxwsqyu]{grid-template-columns:1fr 1fr 1fr}}\n"}],"routeData":{"route":"/panel","isIndex":false,"type":"page","pattern":"^\\/panel\\/?$","segments":[[{"content":"panel","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/panel.astro","pathname":"/panel","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/perfil.wnAvcPm8.css"},{"type":"external","src":"_astro/Layout.DiqXc5M_.css"}],"routeData":{"route":"/perfil","isIndex":false,"type":"page","pattern":"^\\/perfil\\/?$","segments":[[{"content":"perfil","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/perfil.astro","pathname":"/perfil","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Header.z0GLZhxL.css"},{"type":"external","src":"_astro/Layout.DiqXc5M_.css"},{"type":"inline","content":".cta-section[data-astro-cid-zvmdtend]{background-color:var(--color-cream);padding:3rem 0}.cta-box[data-astro-cid-zvmdtend]{background:var(--color-cream-dark);border-radius:var(--radius-lg);text-align:center;flex-direction:column;align-items:center;gap:1rem;padding:3rem 2rem;display:flex}.cta-title[data-astro-cid-zvmdtend]{font-family:var(--font-serif);color:var(--color-navy);font-size:clamp(1.4rem,3vw,1.8rem);font-weight:700}.cta-desc[data-astro-cid-zvmdtend]{color:var(--color-text-muted);max-width:480px;font-size:.95rem}.cta-btn[data-astro-cid-zvmdtend]{background:var(--color-navy);color:var(--color-white);border-radius:var(--radius-sm);align-items:center;gap:.5rem;margin-top:.25rem;padding:.8rem 1.75rem;font-size:.95rem;font-weight:600;transition:background .2s;display:inline-flex}.cta-btn[data-astro-cid-zvmdtend]:hover{background:var(--color-navy-light)}.footer[data-astro-cid-zvmdtend]{background:var(--color-white);border-top:1px solid var(--color-border);padding:3.5rem 0 0}.footer-top[data-astro-cid-zvmdtend]{grid-template-columns:2fr 1fr 1fr;gap:3rem;padding-bottom:3rem;display:grid}.footer-logo[data-astro-cid-zvmdtend]{align-items:center;gap:.5rem;margin-bottom:.75rem;display:inline-flex}.footer-logo[data-astro-cid-zvmdtend] span[data-astro-cid-zvmdtend]{font-family:var(--font-serif);color:var(--color-navy);font-size:1.2rem;font-weight:700}.footer-brand[data-astro-cid-zvmdtend]{flex-direction:column;gap:.5rem;display:flex}.footer-desc[data-astro-cid-zvmdtend]{color:var(--color-text-muted);max-width:320px;font-size:.9rem;line-height:1.55}.footer-verse[data-astro-cid-zvmdtend]{color:var(--color-text-muted);border-left:3px solid var(--color-gold);margin-top:.5rem;padding-left:.75rem;font-size:.85rem;font-style:italic;line-height:1.55}.footer-nav[data-astro-cid-zvmdtend] h3[data-astro-cid-zvmdtend]{letter-spacing:.08em;color:var(--color-text-muted);margin-bottom:1rem;font-size:.78rem;font-weight:700}.footer-nav[data-astro-cid-zvmdtend] ul[data-astro-cid-zvmdtend]{flex-direction:column;gap:.6rem;list-style:none;display:flex}.footer-nav[data-astro-cid-zvmdtend] a[data-astro-cid-zvmdtend]{color:var(--color-text);font-size:.9rem;transition:color .2s}.footer-nav[data-astro-cid-zvmdtend] a[data-astro-cid-zvmdtend]:hover{color:var(--color-navy)}.footer-bottom[data-astro-cid-zvmdtend]{border-top:1px solid var(--color-border);color:var(--color-text-muted);flex-wrap:wrap;justify-content:space-between;align-items:center;gap:.5rem;padding:1.25rem 0;font-size:.85rem;display:flex}.footer-heart[data-astro-cid-zvmdtend]{color:var(--color-text-muted)}.footer-heart[data-astro-cid-zvmdtend] span[data-astro-cid-zvmdtend]{color:#c8872a}@media (width<=768px){.footer-top[data-astro-cid-zvmdtend]{grid-template-columns:1fr;gap:2rem}}\n"},{"type":"external","src":"_astro/BookCard.C2bnUKOA.css"},{"type":"inline","content":".page-hero[data-astro-cid-bmkygcgj]{background:var(--color-navy);color:var(--color-white);padding:3.5rem 0}.page-title[data-astro-cid-bmkygcgj]{font-family:var(--font-serif);margin-bottom:.5rem;font-size:clamp(2rem,4vw,2.75rem);font-weight:700}.page-desc[data-astro-cid-bmkygcgj]{color:#ffffffb3;max-width:500px;font-size:1rem}.guias-grid[data-astro-cid-bmkygcgj]{grid-template-columns:repeat(2,1fr);gap:1.25rem;display:grid}.guia-card[data-astro-cid-bmkygcgj]{background:var(--color-white);border:1px solid var(--color-border);border-radius:var(--radius-lg);box-shadow:var(--shadow-sm);align-items:center;gap:1rem;padding:1.25rem;transition:box-shadow .2s;display:flex}.guia-card[data-astro-cid-bmkygcgj]:hover{box-shadow:var(--shadow-md)}.guia-icon[data-astro-cid-bmkygcgj]{border-radius:var(--radius-sm);width:52px;min-width:52px;height:52px;color:var(--color-navy);background:#0d22400f;justify-content:center;align-items:center;display:flex}.guia-info[data-astro-cid-bmkygcgj]{flex-direction:column;flex:1;gap:.2rem;display:flex}.guia-tipo[data-astro-cid-bmkygcgj]{color:var(--color-gold);text-transform:uppercase;letter-spacing:.05em;font-size:.75rem;font-weight:600}.guia-titulo[data-astro-cid-bmkygcgj]{font-family:var(--font-serif);color:var(--color-navy);font-size:.95rem;font-weight:700;line-height:1.3}.guia-paginas[data-astro-cid-bmkygcgj]{color:var(--color-text-muted);font-size:.8rem}.guia-btn[data-astro-cid-bmkygcgj]{background:var(--color-navy);color:var(--color-white);border-radius:var(--radius-sm);white-space:nowrap;align-items:center;gap:.35rem;padding:.5rem .9rem;font-size:.85rem;font-weight:500;transition:background .2s;display:flex}.guia-btn[data-astro-cid-bmkygcgj]:hover{background:var(--color-navy-light)}.libros-grid[data-astro-cid-bmkygcgj]{grid-template-columns:repeat(4,1fr);gap:1.5rem;display:grid}@media (width<=900px){.guias-grid[data-astro-cid-bmkygcgj]{grid-template-columns:1fr}.libros-grid[data-astro-cid-bmkygcgj]{grid-template-columns:repeat(2,1fr)}}@media (width<=480px){.libros-grid[data-astro-cid-bmkygcgj]{grid-template-columns:1fr}}\n"}],"routeData":{"route":"/recursos","isIndex":false,"type":"page","pattern":"^\\/recursos\\/?$","segments":[[{"content":"recursos","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/recursos.astro","pathname":"/recursos","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Header.z0GLZhxL.css"},{"type":"external","src":"_astro/Layout.DiqXc5M_.css"},{"type":"external","src":"_astro/subir-libro.BBLC0XZa.css"}],"routeData":{"route":"/subir-libro","isIndex":false,"type":"page","pattern":"^\\/subir-libro\\/?$","segments":[[{"content":"subir-libro","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/subir-libro.astro","pathname":"/subir-libro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Header.z0GLZhxL.css"},{"type":"external","src":"_astro/Layout.DiqXc5M_.css"},{"type":"external","src":"_astro/index.BwgegIZA.css"},{"type":"external","src":"_astro/BookCard.C2bnUKOA.css"},{"type":"inline","content":".cta-section[data-astro-cid-zvmdtend]{background-color:var(--color-cream);padding:3rem 0}.cta-box[data-astro-cid-zvmdtend]{background:var(--color-cream-dark);border-radius:var(--radius-lg);text-align:center;flex-direction:column;align-items:center;gap:1rem;padding:3rem 2rem;display:flex}.cta-title[data-astro-cid-zvmdtend]{font-family:var(--font-serif);color:var(--color-navy);font-size:clamp(1.4rem,3vw,1.8rem);font-weight:700}.cta-desc[data-astro-cid-zvmdtend]{color:var(--color-text-muted);max-width:480px;font-size:.95rem}.cta-btn[data-astro-cid-zvmdtend]{background:var(--color-navy);color:var(--color-white);border-radius:var(--radius-sm);align-items:center;gap:.5rem;margin-top:.25rem;padding:.8rem 1.75rem;font-size:.95rem;font-weight:600;transition:background .2s;display:inline-flex}.cta-btn[data-astro-cid-zvmdtend]:hover{background:var(--color-navy-light)}.footer[data-astro-cid-zvmdtend]{background:var(--color-white);border-top:1px solid var(--color-border);padding:3.5rem 0 0}.footer-top[data-astro-cid-zvmdtend]{grid-template-columns:2fr 1fr 1fr;gap:3rem;padding-bottom:3rem;display:grid}.footer-logo[data-astro-cid-zvmdtend]{align-items:center;gap:.5rem;margin-bottom:.75rem;display:inline-flex}.footer-logo[data-astro-cid-zvmdtend] span[data-astro-cid-zvmdtend]{font-family:var(--font-serif);color:var(--color-navy);font-size:1.2rem;font-weight:700}.footer-brand[data-astro-cid-zvmdtend]{flex-direction:column;gap:.5rem;display:flex}.footer-desc[data-astro-cid-zvmdtend]{color:var(--color-text-muted);max-width:320px;font-size:.9rem;line-height:1.55}.footer-verse[data-astro-cid-zvmdtend]{color:var(--color-text-muted);border-left:3px solid var(--color-gold);margin-top:.5rem;padding-left:.75rem;font-size:.85rem;font-style:italic;line-height:1.55}.footer-nav[data-astro-cid-zvmdtend] h3[data-astro-cid-zvmdtend]{letter-spacing:.08em;color:var(--color-text-muted);margin-bottom:1rem;font-size:.78rem;font-weight:700}.footer-nav[data-astro-cid-zvmdtend] ul[data-astro-cid-zvmdtend]{flex-direction:column;gap:.6rem;list-style:none;display:flex}.footer-nav[data-astro-cid-zvmdtend] a[data-astro-cid-zvmdtend]{color:var(--color-text);font-size:.9rem;transition:color .2s}.footer-nav[data-astro-cid-zvmdtend] a[data-astro-cid-zvmdtend]:hover{color:var(--color-navy)}.footer-bottom[data-astro-cid-zvmdtend]{border-top:1px solid var(--color-border);color:var(--color-text-muted);flex-wrap:wrap;justify-content:space-between;align-items:center;gap:.5rem;padding:1.25rem 0;font-size:.85rem;display:flex}.footer-heart[data-astro-cid-zvmdtend]{color:var(--color-text-muted)}.footer-heart[data-astro-cid-zvmdtend] span[data-astro-cid-zvmdtend]{color:#c8872a}@media (width<=768px){.footer-top[data-astro-cid-zvmdtend]{grid-template-columns:1fr;gap:2rem}}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/Users/useit/Desktop/familias/front/src/pages/autor/[slug].astro",{"propagation":"none","containsHead":true}],["/Users/useit/Desktop/familias/front/src/pages/libro/[slug].astro",{"propagation":"none","containsHead":true}],["/Users/useit/Desktop/familias/front/src/pages/leer/[slug].astro",{"propagation":"none","containsHead":true}],["/Users/useit/Desktop/familias/front/src/pages/auth/login.astro",{"propagation":"none","containsHead":true}],["/Users/useit/Desktop/familias/front/src/pages/auth/registro.astro",{"propagation":"none","containsHead":true}],["/Users/useit/Desktop/familias/front/src/pages/autores.astro",{"propagation":"none","containsHead":true}],["/Users/useit/Desktop/familias/front/src/pages/biblioteca.astro",{"propagation":"none","containsHead":true}],["/Users/useit/Desktop/familias/front/src/pages/dashboard.astro",{"propagation":"none","containsHead":true}],["/Users/useit/Desktop/familias/front/src/pages/galeria-familiar.astro",{"propagation":"none","containsHead":true}],["/Users/useit/Desktop/familias/front/src/pages/galeria.astro",{"propagation":"none","containsHead":true}],["/Users/useit/Desktop/familias/front/src/pages/index.astro",{"propagation":"none","containsHead":true}],["/Users/useit/Desktop/familias/front/src/pages/libro/[slug]/leer.astro",{"propagation":"none","containsHead":true}],["/Users/useit/Desktop/familias/front/src/pages/panel.astro",{"propagation":"none","containsHead":true}],["/Users/useit/Desktop/familias/front/src/pages/panel/guardados.astro",{"propagation":"none","containsHead":true}],["/Users/useit/Desktop/familias/front/src/pages/panel/publicaciones.astro",{"propagation":"none","containsHead":true}],["/Users/useit/Desktop/familias/front/src/pages/perfil.astro",{"propagation":"none","containsHead":true}],["/Users/useit/Desktop/familias/front/src/pages/recursos.astro",{"propagation":"none","containsHead":true}],["/Users/useit/Desktop/familias/front/src/pages/subir-libro.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.0ZIQHWEE.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:page:src/pages/libro/[slug]@_@astro":"chunks/_slug__C6d1Nzz0.mjs","\u0000virtual:astro:page:src/pages/autor/[slug]@_@astro":"chunks/_slug__gnAf3ngg.mjs","\u0000virtual:astro:page:src/pages/leer/[slug]@_@astro":"chunks/_slug__ou_I9jTV.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/autores@_@astro":"chunks/autores_loLT644l.mjs","\u0000virtual:astro:page:src/pages/biblioteca@_@astro":"chunks/biblioteca_BSEbCM9Q.mjs","\u0000virtual:astro:page:src/pages/dashboard@_@astro":"chunks/dashboard_D4VWIc3M.mjs","\u0000virtual:astro:page:src/pages/api/descargar@_@ts":"chunks/descargar_D-uq1lFV.mjs","\u0000virtual:astro:page:src/pages/galeria-familiar@_@astro":"chunks/galeria-familiar_Bzp9T4Y0.mjs","\u0000virtual:astro:page:src/pages/galeria@_@astro":"chunks/galeria_Ds5CUuld.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_B50XY-tM.mjs","\u0000virtual:astro:page:src/pages/panel/guardados@_@astro":"chunks/guardados_BwARIKuB.mjs","\u0000virtual:astro:page:src/pages/api/guardar@_@ts":"chunks/guardar_CEAz1-YQ.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_Bt1hk8P5.mjs","\u0000virtual:astro:page:src/pages/libro/[slug]/leer@_@astro":"chunks/leer_Bp7b7yn4.mjs","\u0000virtual:astro:page:src/pages/auth/login@_@astro":"chunks/login_Db7yw_OK.mjs","\u0000virtual:astro:page:src/pages/panel@_@astro":"chunks/panel_Cp9jEB0T.mjs","\u0000virtual:astro:page:src/pages/perfil@_@astro":"chunks/perfil_CAPtBm_t.mjs","\u0000virtual:astro:page:src/pages/panel/publicaciones@_@astro":"chunks/publicaciones_CbIyWQbp.mjs","\u0000virtual:astro:page:src/pages/recursos@_@astro":"chunks/recursos_Dgxgfwz_.mjs","\u0000virtual:astro:page:src/pages/auth/registro@_@astro":"chunks/registro_C7oI0Czq.mjs","\u0000virtual:astro:page:src/pages/api/seguir@_@ts":"chunks/seguir_D_P4xfVY.mjs","/Users/useit/Desktop/familias/front/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_DObHJDIj.mjs","\u0000virtual:astro:page:src/pages/subir-libro@_@astro":"chunks/subir-libro_B_50hxp4.mjs","/Users/useit/Desktop/familias/front/src/components/CtaFooter.astro?astro&type=script&index=0&lang.ts":"_astro/CtaFooter.astro_astro_type_script_index_0_lang.BQHwERkG.js","/Users/useit/Desktop/familias/front/src/components/FamiliasParticipantes.astro?astro&type=script&index=0&lang.ts":"_astro/FamiliasParticipantes.astro_astro_type_script_index_0_lang.C35cpAiZ.js","/Users/useit/Desktop/familias/front/src/components/Header.astro?astro&type=script&index=0&lang.ts":"_astro/Header.astro_astro_type_script_index_0_lang.M13SQM22.js","/Users/useit/Desktop/familias/front/src/components/Hero.astro?astro&type=script&index=0&lang.ts":"_astro/Hero.astro_astro_type_script_index_0_lang.CiR4BQ6G.js","/Users/useit/Desktop/familias/front/src/components/LoginModal.astro?astro&type=script&index=0&lang.ts":"_astro/LoginModal.astro_astro_type_script_index_0_lang.B9qSp_2L.js","/Users/useit/Desktop/familias/front/src/components/VideosRecientes.astro?astro&type=script&index=0&lang.ts":"_astro/VideosRecientes.astro_astro_type_script_index_0_lang.DEwMLvtr.js","/Users/useit/Desktop/familias/front/src/components/VideosRecientes.astro?astro&type=script&index=1&lang.ts":"_astro/VideosRecientes.astro_astro_type_script_index_1_lang.mluFIuQg.js","/Users/useit/Desktop/familias/front/src/pages/dashboard.astro?astro&type=script&index=0&lang.ts":"_astro/dashboard.astro_astro_type_script_index_0_lang.CvkgcEna.js","/Users/useit/Desktop/familias/front/src/pages/galeria-familiar.astro?astro&type=script&index=0&lang.ts":"_astro/galeria-familiar.astro_astro_type_script_index_0_lang.beQLykKC.js","/Users/useit/Desktop/familias/front/src/pages/auth/login.astro?astro&type=script&index=0&lang.ts":"_astro/login.astro_astro_type_script_index_0_lang.4rKf4uIE.js","/Users/useit/Desktop/familias/front/src/pages/panel.astro?astro&type=script&index=0&lang.ts":"_astro/panel.astro_astro_type_script_index_0_lang.CiR4BQ6G.js","/Users/useit/Desktop/familias/front/src/pages/perfil.astro?astro&type=script&index=0&lang.ts":"_astro/perfil.astro_astro_type_script_index_0_lang.DtbAUJPZ.js","/Users/useit/Desktop/familias/front/src/pages/auth/registro.astro?astro&type=script&index=0&lang.ts":"_astro/registro.astro_astro_type_script_index_0_lang.99H4Vamo.js","/Users/useit/Desktop/familias/front/src/pages/subir-libro.astro?astro&type=script&index=0&lang.ts":"_astro/subir-libro.astro_astro_type_script_index_0_lang.B1g6MFND.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["/Users/useit/Desktop/familias/front/src/components/Hero.astro?astro&type=script&index=0&lang.ts","document.addEventListener(`DOMContentLoaded`,()=>{document.querySelector(`.js-require-login-upload`)?.addEventListener(`click`,e=>{if(localStorage.getItem(`token`))return;e.preventDefault();let t=document.getElementById(`loginModalOverlay`),n=document.getElementById(`modalTitle`),r=document.getElementById(`modalMessage`);n&&(n.textContent=`Inicio de sesión requerido`),r&&(r.textContent=`Debes iniciar sesión para publicar contenido.`),t&&t.classList.add(`active`)})});"],["/Users/useit/Desktop/familias/front/src/components/LoginModal.astro?astro&type=script&index=0&lang.ts","function e(e,t){let n=document.getElementById(`loginModalOverlay`),r=document.getElementById(`modalMessage`),i=document.getElementById(`modalTitle`);n&&r&&(t&&(i.textContent=t),r.textContent=e,n.classList.add(`active`))}function t(){let e=document.getElementById(`loginModalOverlay`);e&&e.classList.remove(`active`)}typeof window<`u`&&document.addEventListener(`DOMContentLoaded`,()=>{let e=document.getElementById(`modalCloseBtn`),t=document.getElementById(`modalCloseButton`),n=document.getElementById(`loginModalOverlay`);e?.addEventListener(`click`,()=>{n?.classList.remove(`active`)}),t?.addEventListener(`click`,()=>{n?.classList.remove(`active`)}),n?.addEventListener(`click`,e=>{e.target===n&&n.classList.remove(`active`)})});export{t as closeLoginModal,e as showLoginModal};"],["/Users/useit/Desktop/familias/front/src/components/VideosRecientes.astro?astro&type=script&index=0&lang.ts","(()=>{let e=document.getElementById(`videos`)?.getAttribute(`data-api`)||`http://localhost:3000/api`,t=[`linear-gradient(135deg,#1565C0,#42A5F5)`,`linear-gradient(135deg,#B71C1C,#EF9A9A)`,`linear-gradient(135deg,#1B5E20,#81C784)`,`linear-gradient(135deg,#F9A825,#FFF176)`,`linear-gradient(135deg,#4527A0,#B39DDB)`];function n(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/\"/g,`&quot;`)}function r(e){let r=e.gradiente||t[Math.floor(Math.random()*t.length)],i=e.duracion?`<span style=\"position:absolute;bottom:.6rem;right:.6rem;background:rgba(0,0,0,.75);color:#fff;font-size:.78rem;font-weight:600;padding:.2rem .5rem;border-radius:4px\">${n(e.duracion)}</span>`:``;return`\n        <article class=\"video-card\" style=\"background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,.1);border:1px solid #e5e7eb;transition:box-shadow .25s,transform .25s\">\n          <button type=\"button\" class=\"video-card-link\"\n            style=\"display:flex;flex-direction:column;width:100%;background:none;border:none;cursor:pointer;text-align:left;padding:0\"\n            aria-label=\"Reproducir: ${n(e.titulo)}\"\n            data-video-url=\"${n(e.url)}\"\n            data-video-titulo=\"${n(e.titulo)}\"\n            data-video-autor=\"${n(e.autor_nombre||`Anónimo`)}\"\n            data-video-slug=\"${n(e.slug)}\">\n            <div class=\"video-thumb\" style=\"position:relative;aspect-ratio:16/9;display:flex;align-items:center;justify-content:center;background:${n(r)};overflow:hidden\">\n              <span style=\"font-size:2.5rem;opacity:.45;pointer-events:none\">${n(e.emoji||`🎬`)}</span>\n              ${i}\n              <div style=\"position:absolute;width:48px;height:48px;background:rgba(255,255,255,.9);border-radius:50%;display:flex;align-items:center;justify-content:center;opacity:0;transition:opacity .2s\" class=\"video-play\">\n                <svg width=\"22\" height=\"22\" viewBox=\"0 0 24 24\" fill=\"#0d2240\"><polygon points=\"5 3 19 12 5 21 5 3\"/></svg>\n              </div>\n            </div>\n            <div style=\"padding:1rem;display:flex;flex-direction:column;gap:.5rem\">\n              <h3 style=\"font-size:1rem;font-weight:700;color:#0d2240;line-height:1.3;margin:0\">${n(e.titulo)}</h3>\n              <div style=\"display:flex;align-items:center;justify-content:space-between;font-size:.85rem;color:#6b7280\">\n                <span>${n(e.autor_nombre||`Anónimo`)}</span>\n                <span style=\"display:flex;align-items:center;gap:.3rem\">\n                  <svg width=\"14\" height=\"14\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\"><path d=\"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z\"/><circle cx=\"12\" cy=\"12\" r=\"3\"/></svg>\n                  ${Number(e.vistas||0).toLocaleString(`es`)}\n                </span>\n              </div>\n            </div>\n          </button>\n        </article>`}async function i(){try{let t=await fetch(`${e}/videos?limit=3`,{cache:`no-store`});if(!t.ok)return;let n=await t.json(),i=Array.isArray(n)?n:n.data||[],a=document.getElementById(`videos`);if(!a)return;let o=document.getElementById(`videosGrid`),s=document.getElementById(`videosEmpty`);if(i.length===0){if(o&&o.remove(),!s){let e=document.createElement(`div`);e.id=`videosEmpty`,e.className=`empty-videos`,e.innerHTML=`<p>Aún no hay videos publicados.</p>`,a.querySelector(`.container`)?.appendChild(e)}return}s&&s.remove(),o||(o=document.createElement(`div`),o.id=`videosGrid`,o.className=`videos-grid`,a.querySelector(`.container`)?.appendChild(o)),o.innerHTML=i.map(r).join(``)}catch{}}window.addEventListener(`community:uploaded`,e=>{e.detail?.mode===`video`&&i()})})();"],["/Users/useit/Desktop/familias/front/src/components/VideosRecientes.astro?astro&type=script&index=1&lang.ts","(()=>{let e=document.getElementById(`videoPlayerModal`),t=document.getElementById(`vplayerBackdrop`),n=document.getElementById(`vplayerClose`),r=document.getElementById(`vplayerVideo`),i=document.getElementById(`vplayerTitulo`),a=document.getElementById(`vplayerAutor`),o=document.querySelector(`meta[name=\"api-url\"]`)?.content||`http://localhost:3000/api`;function s(t,n,s,c){!e||!r||(r.src=t,i&&(i.textContent=n||``),a&&(a.textContent=s||``),e.style.display=`grid`,e.setAttribute(`aria-hidden`,`false`),document.body.style.overflow=`hidden`,r.play().catch(()=>{}),c&&fetch(`${o}/videos/${encodeURIComponent(c)}`).catch(()=>{}))}function c(){!e||!r||(r.pause(),r.src=``,e.style.display=`none`,e.setAttribute(`aria-hidden`,`true`),document.body.style.overflow=``)}document.addEventListener(`click`,e=>{let r=e.target instanceof Element?e.target.closest(`[data-video-url]`):null;if(r){let e=r.getAttribute(`data-video-url`)||``,t=r.getAttribute(`data-video-titulo`)||``,n=r.getAttribute(`data-video-autor`)||``,i=r.getAttribute(`data-video-slug`)||``;e&&s(e,t,n,i);return}(e.target===t||e.target===n)&&c()}),document.addEventListener(`keydown`,t=>{t.key===`Escape`&&e?.style.display!==`none`&&c()})})();"],["/Users/useit/Desktop/familias/front/src/pages/panel.astro?astro&type=script&index=0&lang.ts","document.addEventListener(`DOMContentLoaded`,()=>{document.querySelector(`.js-require-login-upload`)?.addEventListener(`click`,e=>{if(localStorage.getItem(`token`))return;e.preventDefault();let t=document.getElementById(`loginModalOverlay`),n=document.getElementById(`modalTitle`),r=document.getElementById(`modalMessage`);n&&(n.textContent=`Inicio de sesión requerido`),r&&(r.textContent=`Debes iniciar sesión para publicar contenido.`),t&&t.classList.add(`active`)})});"]],"assets":["/favicon.ico","/favicon.svg","/_astro/CtaFooter.astro_astro_type_script_index_0_lang.BQHwERkG.js","/_astro/FamiliasParticipantes.astro_astro_type_script_index_0_lang.C35cpAiZ.js","/_astro/Header.astro_astro_type_script_index_0_lang.M13SQM22.js","/_astro/api.vwouhIdc.js","/_astro/dashboard.astro_astro_type_script_index_0_lang.CvkgcEna.js","/_astro/galeria-familiar.astro_astro_type_script_index_0_lang.beQLykKC.js","/_astro/login.astro_astro_type_script_index_0_lang.4rKf4uIE.js","/_astro/perfil.astro_astro_type_script_index_0_lang.DtbAUJPZ.js","/_astro/registro.astro_astro_type_script_index_0_lang.99H4Vamo.js","/_astro/subir-libro.astro_astro_type_script_index_0_lang.B1g6MFND.js","/logos/logo.png","/_astro/CtaFooter.7D3p66zQ.css","/_astro/_slug_.CEE0cdXL.css","/_astro/_slug_.CntYdCEv.css","/_astro/BookCard.C2bnUKOA.css","/_astro/Header.z0GLZhxL.css","/_astro/Layout.DiqXc5M_.css","/_astro/login.DDwP8eAQ.css","/_astro/registro.B7E1HH9c.css","/_astro/dashboard.Bd5XCDbe.css","/_astro/index.BwgegIZA.css","/_astro/leer.Bi4w_N9S.css","/_astro/guardados.CzT4VZhn.css","/_astro/publicaciones.CDPmhXta.css","/_astro/perfil.wnAvcPm8.css","/_astro/subir-libro.BBLC0XZa.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"hNTAzAVHenkX6hLzjSXYbqTE/89HyZmyxXC162mBHU4=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "8153348b-aeb1-4424-8825-0064d6442fb3") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
