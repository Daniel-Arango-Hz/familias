...
var libros = [
	{
		...
		destacado: true,
		nuevo: true,
		descripcion: "Un cuento ilustrado que lleva a los más pequeños a descubrir la fe a través de los colores y las flores de un jardín mágico. Ideal para leer en familia antes de dormir.",
		paginas: 48,
		anio: 2024,
	...
	},
	{
		...
		destacado: true,
		nuevo: true,
		descripcion: "365 devocionales cortos diseñados para leer en familia cada mañana. Reflexiones bíblicas con aplicaciones prácticas para fortalecer la vida espiritual del hogar.",
		paginas: 380,
		anio: 2024,
	...
	},
	{
		...
		destacado: true,
		nuevo: true,
		descripcion: "Relatos bíblicos narrados con dinamismo para adolescentes. Cada historia explora el valor, la fe y el carácter de personajes como David, Ester, Daniel y muchos más.",
		paginas: 220,
		anio: 2024,
	...
	},
	{
		...
		descargas: 1100,
		destacado: true,
		descripcion: "Una guía práctica para parejas que desean construir un matrimonio sólido sobre principios bíblicos. Incluye reflexiones, preguntas de pareja y planes de acción semanales.",
		paginas: 290,
		anio: 2023,
	...
	},
	{
		...
		descargas: 760,
		nuevo: true,
		descripcion: "Una colección de oraciones poderosas para cada área de la vida familiar: la salud, la provisión, la protección y la unidad. Con versículos bíblicos de respaldo.",
		paginas: 160,
		anio: 2024,
	...
	},
	{
		...
		votos: 143,
		descargas: 3200,
		descripcion: "Los relatos más queridos de la Biblia adaptados para los más pequeños con lenguaje sencillo y actividades para colorear. Un tesoro para cada familia cristiana.",
		paginas: 120,
		anio: 2023,
	...
	},
	{
		...
		votos: 38,
		descargas: 650,
		descripcion: "Un recurso completo para guiar el estudio bíblico en el hogar. Incluye planes de lectura, preguntas de reflexión y actividades para todas las edades.",
		paginas: 340,
		anio: 2023,
	...
	},
	{
		...
		votos: 29,
		descargas: 480,
		descripcion: "Respuestas bíblicas y científicas a las preguntas más desafiantes de la fe moderna. Escrito para jóvenes que desean integrar su fe con el conocimiento contemporáneo.",
		paginas: 195,
		anio: 2022,
